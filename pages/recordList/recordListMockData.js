let recordListData = {
  ...
  data: {
    recordList: [{
      ...
      id: 2,
      entityName: '雪櫃1',
      checkpointName: '貯存設施的衛生狀況',
      status: 3
    }, {
      id: 3,
      entityName: '雪櫃1',
      checkpointName: '標籤標識管理情況',
      status: 2
    }, {
      id: 4,
      entityName: '人員1',
      ...
      id: 5,
      entityName: '雪櫃5',
      checkpointName: '雪櫃溫度的符合性测试文字过长测试文字过长测试文字过长测试文字过长测试文字过长测试文字过长测试文字过长测试文字过长测试文字过长',
      status: 3
    }, {
      id: 6,
      entityName: '雪櫃5',
...
let checkpointRecordListData = {
  code: '0',
  msg: '',
  data: {
    checkpointName: '雪櫃溫度的符合性测试文字过长测试文字过长测试文字过长测试文字过长测试文字过长测试文字过长测试文字过长',
    recordList: [{
      id: 1,
      name: '雪櫃1',
      recordImgs: [
